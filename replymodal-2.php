...
<body>
  ...
  if (isset($_POST["reply"])) {
    if (empty($_POST['R_name']) || empty($_POST["R_email"]) || empty($_POST['R_msg'])) {
      ...
      $insert_into_db = "INSERT INTO comments_reply_reply (name, email, message, comments_reply_id) VALUES ('$R_name', '$R_email', '$R_msg', '$comment_reply_id')";
          ...
          <form action="" method="post" enctype="multipart/form-data">
            <div class="row">
              ...
              <div class="mb-2 col-md-6">
                ...
                <input type="email" name="R_email" id="" class="form-control" value="<?php echo $R_email ?>">
              </div>
            </div>
            <div class="row">
            </div>
            <div class="mb-2">
              ...
              <textarea class="form-control" id="message-text" name="R_msg" style="resize: none; height: 90px;" value="<?php echo $R_msg ?>"></textarea>
            </div>
